      ...
      <div className="w-[100vw]  h-[100vh] flex ">
        ...
        <section className="w-1/2 flex items-center justify-center">
          <div className="w-1/2 h-1/2 rounded-sm border-solid border-[1px] border-slate-200 shadow-xl flex flex-col justify-center items-center">
            ...
            <input
              className="w-3/4 h-10 mt-4 rounded-md border-solid border-[1px] border-slate-200 pl-4 placeholder:text-sm"
              type="text"
            ...
            <div className="w-3/4 h-11 rounded-md bg-gray-100 border-[1px] border-gray-200 text-[#5a5a5a]  flex items-center justify-center mt-4">
              회원가입
            </div>
          </div>
        </section>
