...
//           {/* 문제 등록 버튼 */}
//           <button className="px-4 py-2 bg-primary text-white rounded-md font-normal">
//             문제 등록
//           </button>
...
//             <button
//               onClick={() =>
//                 setCurrentPage((prev) => Math.max(prev - pagesPerBlock, 1))
//               }
...
//               onClick={() =>
//                 setCurrentPage((prev) =>
//                   Math.min(prev + pagesPerBlock, totalPages),
//                 )
//               }
