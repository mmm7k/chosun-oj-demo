...
// // 성적 분포 데이터를 생성하는 헬퍼 함수
// const generateSampleData = (peak = 50, spread = 20) => {
//   const data = [];
//   for (let i = 0; i <= 100; i++) {
//     const exponent = -Math.pow(i - peak, 2) / (2 * Math.pow(spread, 2));
//     const value = Math.round(100 * Math.exp(exponent));
//     data.push(value);
//   }
//   return data;
// };
...
// // 우측 성적 분포 바 차트 데이터
// const barData = {
//   labels: Array.from({ length: 101 }, (_, i) => i), // 0~100까지 성적 범위
//   datasets: [
//     {
//       label: '알고리즘 01 분반',
//       data: generateSampleData(70, 15),
//       backgroundColor: 'rgba(255, 99, 132, 0.5)',
//     },
//     {
//       label: '알고리즘 02 분반',
//       data: generateSampleData(60, 20),
//       backgroundColor: 'rgba(255, 159, 64, 0.5)',
//     },
//     {
//       label: '네트워크 보안 01 분반',
//       data: generateSampleData(50, 25),
//       backgroundColor: 'rgba(54, 162, 235, 0.5)',
//     },
//     {
//       label: '네트워크 보안 02 분반',
//       data: generateSampleData(40, 30),
//       backgroundColor: 'rgba(75, 192, 192, 0.5)',
//     },
//   ],
// };

// // 바 그래프 옵션 (성적 범위 및 인원수 축)
// const barOptions = {
//   responsive: true,
