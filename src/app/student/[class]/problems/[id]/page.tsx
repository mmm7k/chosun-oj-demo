...
//         <div className="h-14 bg-[#001d5e] text-white flex items-center px-12">
...
//           {/* 왼쪽 섹션 */}
//           <div className="w-1/2 px-12 py-5  space-y-5">
...
//             />
//             {/* 오른쪽 섹션 - 실행 결과 */}
//             <div className="h-[50%]  bg-gray-100 border-t border-gray-300">
...
//         {/* 푸터 */}
//         <div className="h-16 bg-white text-white flex items-center justify-between px-12 border-t border-gray-300">
//           {/* 왼쪽 버튼 */}
