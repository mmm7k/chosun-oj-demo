      ...
      <div className="w-full h-full flex flex-col space-y-7">
        ...
        <div>
          ...
          >
            ...
            {isJavaDropdownOpen ? (
              <IoChevronUp
                className={`${decodeURIComponent(course) === '자바 프로그래밍' ? 'text-primary' : 'text-gray-500'}`}
              />
            ) : (
              <IoChevronDown
                className={`${decodeURIComponent(course) === '자바 프로그래밍' ? 'text-primary' : 'text-gray-500'}`}
        ...
        <div>
          ...
          >
            ...
            {isBasicDropdownOpen ? (
              <IoChevronUp
                className={`${decodeURIComponent(course) === '기초 프로그래밍' ? 'text-primary' : 'text-gray-500'}`}
              />
            ) : (
              <IoChevronDown
                className={`${decodeURIComponent(course) === '기초 프로그래밍' ? 'text-primary' : 'text-gray-500'}`}
        ...
        <div>
          ...
          >
            ...
            {isAlgorithmDropdownOpen ? (
              <IoChevronUp
                className={`${decodeURIComponent(course) === '알고리즘' ? 'text-primary' : 'text-gray-500'}`}
              />
            ) : (
              <IoChevronDown
                className={`${decodeURIComponent(course) === '알고리즘' ? 'text-primary' : 'text-gray-500'}`}
