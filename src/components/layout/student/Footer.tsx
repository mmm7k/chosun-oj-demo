export default function Footer() {
  return (
    <footer className="h-72 w-full px-[10%] lg:px-[19%] bg-white text-sm text-gray-400 pt-14 flex flex-col sm:flex-row space-y-5 sm:space-y-0 sm:space-x-20 shadow-top-only ">
